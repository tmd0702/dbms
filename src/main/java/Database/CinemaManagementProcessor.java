...
public class CinemaManagementProcessor extends Processor {
    ...
    public Response getData(int from, int quantity, String queryCondition, String sortQuery) {
        Response response = select("CINEMAS.ID AS 'CINEMAS.ID', CINEMAS.NAME AS 'CINEMAS.NAME', CINEMAS.ADDRESS AS 'CINEMAS.ADDRESS'", from, quantity, queryCondition, sortQuery, getDefaultDatabaseTable());
        return response;
    }
